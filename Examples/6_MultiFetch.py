...
sys.path.append("C:/IPG/carmaker/win64-10.2/Python")
...
if __name__ == "__main__":
    ...
    try:
        ...
        MyTestbench = MyTestbenchFactory.CreateVendorSpecificTestBench("IPG", "CarMaker", "10.2")
        ...
        print("Simulation finished. Results saved in ProjectDir: " + DemoMAPort.Configuration.Project)
